...
registerBlockType('tainacan/collections-list', {
    ...
    icon:
        <svg width="24" height="24" viewBox="0 -5 12 16">
            <path
                    fill="#298596"
                    d="M10,8.8v1.3H1.2C0.6,10.1,0,9.5,0,8.8V2.5h1.3v6.3H10z M6.9,0H3.8C3.1,0,2.5,0.6,2.5,1.3l0,5c0,0.7,0.6,1.2,1.3,1.2h7.5c0.7,0,1.3-0.6,1.3-1.2V2.5c0-0.7-0.6-1.2-1.3-1.2H8.2L6.9,0z"/>       
        </svg>,
